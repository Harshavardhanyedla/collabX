...
const Profile: React.FC = () => {
    // Mock user data
    const user = {
        name: 'Harshavardhan Yadla',
        role: 'Full Stack Developer',
        institution: 'IIT Bombay',
        bio: 'Passionate about building scalable web applications and exploring AI/ML. Currently working on a student community platform.',
        ...
        skills: ['React', 'TypeScript', 'Node.js', 'Python', 'AWS', 'Tailwind CSS'],
        socials: {
            github: 'github.com/harsha',
            linkedin: 'linkedin.com/in/harsha',
            twitter: 'twitter.com/harsha'
        }
    };
                    ...
                    >
                        <div className="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm text-center">
                            ...
                            <div className="flex justify-center gap-4 mb-8">
                                <button className="p-2 rounded-full bg-gray-50 text-gray-600 hover:bg-[#5865F2] hover:text-white transition-colors">
                                ...
                                <button className="p-2 rounded-full bg-gray-50 text-gray-600 hover:bg-[#0077b5] hover:text-white transition-colors">
